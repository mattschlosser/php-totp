...
class TotpSecretTest extends TestCase
{
    ...
    /**
     * Test the TotpSecret destructor.
     *
    ...
    public function testDestructor(string $secret): void
    {
        ...
        $rawProperty = new ReflectionProperty($totpSecret, "m_raw");
        $rawProperty->setAccessible(true);

        /** @noinspection PhpUnhandledExceptionInspection */
        $base32Property = new ReflectionProperty($totpSecret, "m_base32");
        $base32Property->setAccessible(true);

        /** @noinspection PhpUnhandledExceptionInspection */
        $base64Property = new ReflectionProperty($totpSecret, "m_base64");
